# Autorisatie-flow Zorgaanbieder: QBR-0001-ZA.graphql

Beschrijving van het autorisatieproces door de PEP, voor query [GBR-0001-ZA.graphql](/gql-query/zorgaanbieder/QBR-0001-ZA.graphql).
...
stateDiagram
  ...
  indienen: Ontvang  QBR-0001-ZA.graphql + Access token
