...
| [NIEUWE_REGIEHOUDER_ZORGKANTOOR](./nieuwe_regiehouder_zorgkantoor.md) | Notificatie aan het uitvoerende zorgkantoor dat op het moment dat het verantwoordelijke zorgkantoor een `Regiehouder` heeft geregistreerd een actuele `Bemiddelingsspecificatie` heeft. | VERPLICHT* |
| [GEWIJZIGDE_REGIEHOUDER_ZORGKANTOOR](./gewijzigde_regiehouder_zorgkantoor.md) | Notificatie aan het uitvoerende zorgkantoor dat op het moment dat het verantwoordelijke zorgkantoor een `Regiehouder` heeft gewijzigd een actuele `Bemiddelingsspecificatie` heeft. | VERPLICHT* |
| [VERWIJDERDE_REGIEHOUDER_ZORGKANTOOR](./verwijderde_regiehouder_zorgkantoor.md) | Notificatie aan het uitvoerende zorgkantoor dat op het moment dat het verantwoordelijke zorgkantoor een `Regiehouder` heeft verwijderd een actuele `Bemiddelingsspecificatie` heeft. | VERPLICHT* |
